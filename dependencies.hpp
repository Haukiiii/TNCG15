...
constexpr int DIFF_BOUNCES{ 1 }; // Amount of sampled diffuse bounces TODO: currently not working?
...
constexpr double FLUX_DROPOFF{ 2.0 }; // Used to simulate how light intensity decreases with distance.
...
constexpr size_t res{ 300 }; //resolution of the image (res*res) 800
